    ...
    <div class="flex flex-col gap-4 p-5">
      ...
      <div class="flex gap-2 justify-end">
        ...
        <button
          data-role="keep"
          type="button"
          class="rounded-xl px-4 py-2 text-sm font-semibold bg-accent text-bg hover:opacity-90 focus-visible:opacity-90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"></button>
      </div>
    </div>
  `
